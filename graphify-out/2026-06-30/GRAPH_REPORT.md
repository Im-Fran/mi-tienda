...
- 112 files · ~35,966 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 701 nodes · 808 edges · 84 communities (49 shown, 35 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 217 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `a627e82e`
...
Cohesion: 0.09
Nodes (23): CategoriesPage(), CategoryNodeProps, ProductForm, ProductFormPage(), VariantForm, ProductsPage(), useCategories(), useCreateCategory() (+15 more)
...
Cohesion: 0.06
Nodes (35): dependencies, @base-ui/react, class-variance-authority, clsx, @fontsource-variable/geist, @hookform/resolvers, lucide-react, next-themes (+27 more)
...
- **Why does `cn()` connect `UI Utilities & Controls` to `UI Dropdown Menu`, `Cart Hooks`, `UI Dialog`, `UI Sheet`, `Customer Detail & Utils`, `UI Card`, `UI Avatar`, `UI Alert`, `UI Progress`, `UI Tabs`, `UI Tooltip`, `Image Uploader`, `Status Badge`, `Loading Spinner`, `Markdown Renderer`, `UI Badge`, `UI Button`, `UI Checkbox`, `UI Label`, `UI Separator`, `UI Switch`, `UI Textarea`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `formatCurrency()` connect `Cart Hooks` to `Admin Categories & Products`, `Admin Stats & Charts`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `useStores()` connect `Cart Hooks` to `Admin Categories & Products`, `Admin Auth & Dashboard`, `Admin Store Settings`?**
