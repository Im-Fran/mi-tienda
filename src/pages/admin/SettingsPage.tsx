      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="countries">
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">Select countries you ship to.</p>
        ...
        <TabsContent value="bank">
          <form onSubmit={handleSettings(onSaveSettings)} className="space-y-4">
            <p className="text-sm text-muted-foreground">Bank account details shown to customers when they choose bank transfer payment.</p>
